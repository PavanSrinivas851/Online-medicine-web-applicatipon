        ...
        <div id="mask"> 
          <div id="item1" class="item"> 
            <div class="content"> 
              ...
              <!--topContent-->
              <div id="aside"> 
                <p><strong><font color="#CC66FF" size="+1">Feedbacks</font></strong></p>
                <div class="post-block" id="scrol"> 
                  <form action="#" name="form" method="post">
                    <table align="center" width="800" style="border:1px solid #66CC33;" bgcolor="#FFFFFF">
                      <!--DWLayoutTable-->
                      <tr class="button3" style="border:1px solid #CCCCCC;"> 
                        <td width="90" style="border:1px solid #CCCCCC;" height="35"><font color="#FF0000"><strong>First 
                          Name</strong></font></td>
                        <td width="90" style="border:1px solid #CCCCCC;" height="35"><font color="#FF0000"><strong>Last 
                          Name</strong></font></td>
                        <td width="80" style="border:1px solid #CCCCCC;"><font color="#FF0000"><strong>Phone</strong></font></td>
                        <td width="100" style="border:1px solid #CCCCCC;"><font color="#FF0000"><strong>E-mail</strong></font></td>
                        <td width="110" style="border:1px solid #CCCCCC;"><font color="#FF0000"><strong>Message</strong></font></td>
                        <td width="70" style="border:1px solid #CCCCCC;"><font color="#FF0000"><strong>Date</strong></font></td>
...
while(rs.next())
  ...
  %>
                      <tr class="paragraping2" style="border:1px solid #CCCCCC;"> 
                        ...
                        <td width="80" style="border:1px solid #CCCCCC;"> <a  href="deletecontact.jsp?<%=rs.getString(4)%>"><strong>Delete</strong></a> 
                        </td>
                        <%
}
