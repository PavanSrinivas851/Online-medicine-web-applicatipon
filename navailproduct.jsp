        ...
        <div id="mask"> 
          <div id="item1" class="item"> 
            <div class="content"> 
              ...
              <!--topContent-->
              <div id="aside"> 
                <p><strong><font color="#CC66FF" size="+1">Not Available Products</font></strong></p>
                <div class="post-block" id="scrol"> 
                  <form action="#" name="form" method="post">
                    <table align="center" width="900" style="border:1px solid #66CC33;" bgcolor="#FFFFFF">
                      ...
                      <% 
					String sale="Not Available";
try

        {

Class.forName("com.mysql.jdbc.Driver"); 
	Connection con=DriverManager.getConnection("jdbc:mysql://localhost:3306/pharmacy","root","sk");

Statement st=con.createStatement();

String sql="select * from  medicine where sale='"+sale+"'";
...
while(rs.next())
  ...
  %>
                      <tr class="paragraping2" style="border:1px solid #CCCCCC;"> 
                        ...
                        <td width="80" style="border:1px solid #CCCCCC;"> <a  href="deleteproduct.jsp?<%=rs.getString(1)%>"><strong>Delete</strong></a> 
