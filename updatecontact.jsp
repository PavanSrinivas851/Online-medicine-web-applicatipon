  ...
  <div id="wrap"> 
            ...
            <div class="content"> 
              ...
              <div id="aside"> 
                ...
                <div class="post-block" id="scrol"> 
                  <form action="updatecontact1.jsp" name="form" method="post" onSubmit="return validation1()">
   ...
   // String strreplace = " ";
    ...
    try      
	{
		...
		con = DriverManager.getConnection("jdbc:mysql://localhost:3306/pharmacy","root","sk");
	    stmt1=con.prepareStatement("select * from contact where email='"+email+"'");
	   ...
	   %>
                      ...
                      <tr> 
                        ...
                        <td><select name="category" style="background-color:violet;">
                            ...
                            <option value="Diabetic Testing Strips">Diabetic Testing 
                            Strips</option>
                      ...
                      <tr> 
                        <td>Sale:</td>
                        <td><input type="text" style="background-color:violet" name="edate" value="<%=rs1.getString(12)%>"></td>
                      </tr>
                      <tr> 
